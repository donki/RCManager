<#
.SYNOPSIS
    Crea en Entra ID el registro de aplicacion que necesita sOC Remote Connections Manager (OneDrive).
...
.EXAMPLE
    .\Registrar-Entra.ps1
    .\Registrar-Entra.ps1 -Nombre "sOC Remote Connections Manager" -Tenant contoso.onmicrosoft.com
#>

[CmdletBinding()]
param(
    [string]$Nombre = 'sOC Remote Connections Manager',
...
Write-Host "  <RcMicrosoftClientId>$($app.appId)</RcMicrosoftClientId>"
Write-Host ''
