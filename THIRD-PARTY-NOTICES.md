...
| Google Drive API v3 / Microsoft Graph | Guardar el fichero de conexiones (cifrado) en la carpeta privada de la aplicación en la cuenta del usuario, si el usuario lo elige. Se llaman por HTTP sin SDK. | Términos de las API de Google / Microsoft | Google / Microsoft |
